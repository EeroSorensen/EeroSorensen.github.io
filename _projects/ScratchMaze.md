...
5.  **Enemy sprite** logic runs and continuously follows the player's position around the maze
...
8.  **Krabby Patty** collision is checked. Upon touching the patty, the player will be sent to a second screen
