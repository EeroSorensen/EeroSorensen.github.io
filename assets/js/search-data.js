...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "A Collection of projects created in KNES 381 - Computer Applications in Kinesiology",
          section: "Navigation",
          handler: () => {
          ...
          title: "CV",
          description: "Kinesiology student at the University of Calgary with interest in adapted physical activity and data analysis",
          section: "Navigation",
          handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/EeroSResume.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%45%65%72%6F%72%69%76@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
